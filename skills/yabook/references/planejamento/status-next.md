# `$yabook plan status` e `$yabook plan next`

Use documentos de visão, versão e roadmap já localizados. Não faça diagnóstico
completo do repositório.

`plan status` informa versão, partes definidas, decisões abertas, riscos,
