...
ROUTES = {
    ...
    "steps": ("C0", ["references/steps.md"], 2400, 1),
    "step": ("C0", ["references/steps.md"], 2400, 1),
    ...
    "dev step": ("C3", ["references/dev.md", "references/git/checkpoint.md", "references/steps.md"], 4600, 3),
